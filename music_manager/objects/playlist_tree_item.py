...
class PlaylistTreeItem:
    def __init__(self, data, is_section = False, parent = None):
        self.item_data = data
    ...
    def appendChild(self, item, is_section):
        self.child_items.append(PlaylistTreeItem(item, is_section, self))
