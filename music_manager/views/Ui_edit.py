...
class Ui_Edit(object):
    def setupUi(self, Edit):
        ...
        self.trackLE = QtWidgets.QLineEdit(Edit)
        ...
        self.cdLE = QtWidgets.QLineEdit(Edit)
        self.cdLE.setObjectName(_fromUtf8("cdLE"))
        self.horizontalLayout_2.addWidget(self.cdLE)
        self.label_11 = QtWidgets.QLabel(Edit)
        self.label_11.setObjectName(_fromUtf8("label_11"))
        self.horizontalLayout_2.addWidget(self.label_11)
        self.bpmLE = QtWidgets.QLineEdit(Edit)
        ...
        self.titleLE = QtWidgets.QLineEdit(Edit)
        self.titleLE.setObjectName(_fromUtf8("titleLE"))
        self.horizontalLayout.addWidget(self.titleLE)
        self.verticalLayout_8.addLayout(self.horizontalLayout)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.artistLE = QtWidgets.QLineEdit(Edit)
        self.artistLE.setObjectName(_fromUtf8("artistLE"))
        self.horizontalLayout_3.addWidget(self.artistLE)
        self.verticalLayout_8.addLayout(self.horizontalLayout_3)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName(_fromUtf8("horizontalLayout_4"))
        self.composerLE = QtWidgets.QLineEdit(Edit)
        ...
        self.albumartistLE = QtWidgets.QLineEdit(Edit)
        self.albumartistLE.setEnabled(True)
        self.albumartistLE.setObjectName(_fromUtf8("albumartistLE"))
        self.horizontalLayout_5.addWidget(self.albumartistLE)
        self.verticalLayout_8.addLayout(self.horizontalLayout_5)
        self.horizontalLayout_12 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_12.setObjectName(_fromUtf8("horizontalLayout_12"))
        self.albumLE = QtWidgets.QLineEdit(Edit)
        ...
        self.label_8 = QtWidgets.QLabel(Edit)
    ...
    def retranslateUi(self, Edit):
        ...
        self.label_2.setText(_translate("Edit", "Artist", None))
        self.label_3.setText(_translate("Edit", "Composer", None))
        self.label_4.setText(_translate("Edit", "Album-Artist", None))
