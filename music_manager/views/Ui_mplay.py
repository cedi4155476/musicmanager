...
class Ui_music(object):
    def setupUi(self, music):
        ...
        self.scrolltitle.setWidget(self.scrollAreaWidgetContents)
        self.verticalLayout.addWidget(self.scrolltitle)
        ...
        self.artist = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        self.artist.setAlignment(QtCore.Qt.AlignCenter)
        self.artist.setObjectName(_fromUtf8("artist"))
        self.verticalLayout_5.addWidget(self.artist)
        self.scrollartist.setWidget(self.scrollAreaWidgetContents_2)
        self.verticalLayout.addWidget(self.scrollartist)
